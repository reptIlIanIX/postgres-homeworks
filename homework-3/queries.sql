...
SELECT customers.company_name, CONCAT(first_name, ' ', last_name) as full_name FROM orders
...
WHERE EXISTS (SELECT * FROM order_details WHERE products.product_id=order_details.product_id AND quantity = 15)